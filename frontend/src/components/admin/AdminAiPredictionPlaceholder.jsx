...
function AdminAiPredictionPlaceholder() {
  return (
    <section className={`mt-8 border-dashed p-6 ${adminSurfaceStyles.mutedPanel}`}>
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <span
          className={`${adminBadgeStyles.base} ${adminBadgeStyles.md} ${adminBadgeStyles.neutral}`}
        >
          연동 예정
        </span>
      </div>

      <div className={`${adminSurfaceStyles.card} mt-5 p-5 text-sm leading-6 text-slate-600`}>
